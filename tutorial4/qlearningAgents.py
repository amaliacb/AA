...
#         print("Corresponding Q-table cell to update:", position, action_column)
        ...
        if reward == 1 or reward== -1:
            ...
            self.q_table[position][action_column] = (1-self.alpha) * self.q_table[position][action_column] + self.alpha * (reward + self.discount * max_action)
